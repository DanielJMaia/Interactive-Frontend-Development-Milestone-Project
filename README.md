...
- The additional filters had to either have display: block or display: flex depending on the screen size. Therefore, it became necessary to define those properties in JavaScript using the screen width property instead of simple CSS. 
